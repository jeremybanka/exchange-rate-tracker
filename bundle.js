...
const $makeSide = (homeOrAway, which) => {
  ...
  const $tale = jquery__WEBPACK_IMPORTED_MODULE_0___default()(`<div/>`)
    .addClass(`tale`)
    .text(tale || quantity)
...
jquery__WEBPACK_IMPORTED_MODULE_2___default()(() => {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_2___default()(`form`).on(`submit`, event => {
    ...
    _biz_Market__WEBPACK_IMPORTED_MODULE_7__.default.convertCurrency({ from, to, howMany })
      .then(conversion => {
        log.add(conversion)
      })
      .catch(error => {
