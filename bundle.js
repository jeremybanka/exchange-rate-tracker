...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ":root {\n  --bg-color: black;\n  --bg-color-2: #060;\n  --fg-color: #0f0;\n}\n\nbody {\n  font-family: Manufab;\n  width: 100vw;\n  height: 100vh;\n  display: flex;\n  flex-direction: column;\n  margin: 0;\n  background: var(--bg-color-2);\n  color: var(--fg-color);\n}\nbody header,\nbody footer,\nbody #bg {\n  flex-grow: 0;\n}\nbody button#clear {\n  position: absolute;\n  top: 10px;\n  right: 10px;\n  color: var(--fg-color);\n  font-size: 18px;\n  font-variation-settings: \"wght\" 300;\n  background: none;\n  border: 2px solid var(--fg-color);\n  height: 30px;\n  width: 30px;\n}\nbody header {\n  justify-content: center;\n  align-items: center;\n  width: 100vw;\n  height: 50px;\n  max-width: 600px;\n  margin: auto;\n  display: flex;\n  flex-direction: row;\n}\nbody header #logo,\nbody header #clear {\n  height: 30px;\n  width: 30px;\n}\nbody header h1 {\n  display: flex;\n  align-items: center;\n  line-height: 30px;\n  height: 40px;\n  font-variation-settings: \"wght\" 700;\n  margin: 0 10px;\n}\nbody main {\n  display: flex;\n  flex-grow: 1;\n  flex-direction: column-reverse;\n}\nbody main > :first-child {\n  background-color: var(--fg-color);\n  color: var(--bg-color);\n}\nbody main > :first-child.error {\n  background-color: #a04;\n}\nbody main section {\n  padding: 10px;\n  display: flex;\n  border-top: 2px solid var(--bg-color);\n  justify-content: center;\n  position: relative;\n}\nbody main section.error {\n  background-color: #f06;\n}\nbody main section .home .tale::after {\n  content: \"=\";\n  font-size: 15px;\n  font-variation-settings: \"wght\" 200;\n  position: absolute;\n  right: -30px;\n  top: 10px;\n}\nbody main section .home {\n  flex-shrink: 1;\n  flex-grow: 1;\n}\nbody main section .away {\n  flex-shrink: 0;\n  flex-grow: 0;\n}\nbody main section .home,\nbody main section .away {\n  width: 50%;\n  display: flex;\n  position: relative;\n  max-width: 300px;\n  flex-direction: column;\n}\nbody main section .home .tale,\nbody main section .home .code,\nbody main section .away .tale,\nbody main section .away .code {\n  text-align: right;\n}\nbody main section .home .tale,\nbody main section .away .tale {\n  font-size: 27px;\n}\nbody footer {\n  padding: 20px;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  width: auto;\n  position: relative;\n}\nbody footer .bg {\n  background: #f003;\n  position: absolute;\n  top: 0px;\n  bottom: 0px;\n  right: 0px;\n  left: 0px;\n}\nbody footer .bg::before {\n  content: \"\";\n  background: var(--bg-color);\n  position: absolute;\n  top: 0px;\n  bottom: 0px;\n  right: 0px;\n  left: 0px;\n}\nbody footer form {\n  display: flex;\n  position: relative;\n  margin: 20px auto;\n  width: 100%;\n  max-width: 600px;\n  flex-direction: column;\n}\nbody footer form section:first-child {\n  display: flex;\n  flex-direction: column;\n}\nbody footer form section:first-child select {\n  -moz-appearance: none;\n  -webkit-appearance: none;\n  font-family: Theia;\n  color: var(--fg-color);\n  font-size: 21px;\n  font-weight: 300;\n  background: none;\n  border: 2px solid var(--fg-color);\n  border-radius: 0;\n  transition-property: outline;\n  transition-duration: 200ms;\n  padding: 5px;\n  position: relative;\n}\nbody footer form section:first-child select::before {\n  content: \"v\";\n  font-family: Icon;\n  display: block;\n  position: absolute;\n  right: 10px;\n  top: 10px;\n}\nbody footer form section:first-child select ~ select {\n  margin-top: 20px;\n}\nbody footer form section:first-child select:focus-within {\n  outline: 1px solid var(--fg-color);\n  background: #020;\n  font-weight: 400;\n}\nbody footer form section:last-child {\n  width: 100%;\n  margin-top: 20px;\n  display: flex;\n  flex-direction: row;\n}\nbody footer form section:last-child input {\n  width: 100%;\n  flex-shrink: 1;\n  font-family: Manufab;\n  text-align: end;\n  color: var(--fg-color);\n  font-size: 40px;\n  font-variation-settings: \"wght\" 600;\n  background: none;\n  border: none;\n  border-bottom: 2px solid var(--fg-color);\n  border-radius: 0;\n  outline: none;\n  margin-right: 20px;\n}\nbody footer form section:last-child button[type=submit] {\n  flex-shrink: 0;\n  font-size: 20px;\n  font-variation-settings: \"wght\" 300;\n  background: var(--fg-color);\n  color: var(--bg-color);\n  border: none;\n  height: 54px;\n  width: 54px;\n}\n\nbutton {\n  cursor: pointer;\n  user-select: none;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-family: Icon;\n  border-radius: 0;\n  border: none;\n  outline: none;\n}\nbutton:hover, button:focus {\n  transform: scale(1.01);\n}\nbutton:active {\n  transition-duration: 10ms;\n  transform: scale(0.99);\n}\n\n/* Fucking dumbass Chrome (29+) that doesn't render variable fonts right */\n@media screen and (-webkit-min-device-pixel-ratio: 0) and (min-resolution: 0.001dpcm) {\n  body header h1 {\n    padding-bottom: 5px;\n  }\n}", "",{"version":3,"sources":["webpack://./src/styles/core.scss"],"names":[],"mappings":"AAAA;EACE,iBAAA;EACA,kBAAA;EACA,gBAAA;AACF;;AACA;EACE,oBAAA;EACA,YAAA;EACA,aAAA;EACA,aAAA;EACA,sBAAA;EACA,SAAA;EACA,6BAAA;EACA,sBAAA;AAEF;AADE;;;EAGE,YAAA;AAGJ;AADE;EACE,kBAAA;EACA,SAAA;EACA,WAAA;EACA,sBAAA;EACA,eAAA;EACA,mCAAA;EACA,gBAAA;EACA,iCAAA;EACA,YAAA;EACA,WAAA;AAGJ;AADE;EACE,uBAAA;EACA,mBAAA;EACA,YAAA;EACA,YAAA;EACA,gBAAA;EACA,YAAA;EACA,aAAA;EACA,mBAAA;AAGJ;AAFI;;EAEE,YAAA;EACA,WAAA;AAIN;AAFI;EACE,aAAA;EACA,mBAAA;EACA,iBAAA;EACA,YAAA;EACA,mCAAA;EACA,cAAA;AAIN;AADE;EACE,aAAA;EACA,YAAA;EACA,8BAAA;AAGJ;AAFI;EACE,iCAAA;EACA,sBAAA;AAIN;AAHM;EACE,sBAAA;AAKR;AAFI;EACE,aAAA;EACA,aAAA;EACA,qCAAA;EACA,uBAAA;EACA,kBAAA;AAIN;AAHM;EACE,sBAAA;AAKR;AAHM;EACE,YAAA;EACA,eAAA;EACA,mCAAA;EACA,kBAAA;EACA,YAAA;EACA,SAAA;AAKR;AAHM;EACE,cAAA;EACA,YAAA;AAKR;AAHM;EACE,cAAA;EACA,YAAA;AAKR;AAHM;;EAEE,UAAA;EACA,aAAA;EACA,kBAAA;EACA,gBAAA;EACA,sBAAA;AAKR;AAJQ;;;;EAEE,iBAAA;AAQV;AANQ;;EACE,eAAA;AASV;AAJE;EACE,aAAA;EACA,aAAA;EACA,sBAAA;EACA,mBAAA;EACA,WAAA;EACA,kBAAA;AAMJ;AALI;EACE,iBAAA;EACA,kBAAA;EACA,QAAA;EACA,WAAA;EACA,UAAA;EACA,SAAA;AAON;AANM;EACE,WAAA;EACA,2BAAA;EACA,kBAAA;EACA,QAAA;EACA,WAAA;EACA,UAAA;EACA,SAAA;AAQR;AALI;EACE,aAAA;EACA,kBAAA;EACA,iBAAA;EACA,WAAA;EACA,gBAAA;EACA,sBAAA;AAON;AANM;EACE,aAAA;EACA,sBAAA;AAQR;AAPQ;EACE,qBAAA;EACA,wBAAA;EACA,kBAAA;EACA,sBAAA;EACA,eAAA;EACA,gBAAA;EACA,gBAAA;EACA,iCAAA;EACA,gBAAA;EACA,4BAAA;EACA,0BAAA;EACA,YAAA;EACA,kBAAA;AASV;AARU;EACE,YAAA;EACA,iBAAA;EACA,cAAA;EACA,kBAAA;EACA,WAAA;EACA,SAAA;AAUZ;AARU;EACE,gBAAA;AAUZ;AARU;EACE,kCAAA;EACA,gBAAA;EACA,gBAAA;AAUZ;AANM;EACE,WAAA;EACA,gBAAA;EACA,aAAA;EACA,mBAAA;AAQR;AAPQ;EACE,WAAA;EACA,cAAA;EACA,oBAAA;EACA,eAAA;EACA,sBAAA;EACA,eAAA;EACA,mCAAA;EACA,gBAAA;EACA,YAAA;EACA,wCAAA;EACA,gBAAA;EACA,aAAA;EACA,kBAAA;AASV;AAPQ;EACE,cAAA;EACA,eAAA;EACA,mCAAA;EACA,2BAAA;EACA,sBAAA;EACA,YAAA;EACA,YAAA;EACA,WAAA;AASV;;AAFA;EACE,eAAA;EACA,iBAAA;EACA,aAAA;EACA,mBAAA;EACA,uBAAA;EACA,iBAAA;EACA,gBAAA;EACA,YAAA;EACA,aAAA;AAKF;AAJE;EAEE,sBAAA;AAKJ;AAHE;EACE,yBAAA;EACA,sBAAA;AAKJ;;AADA,0EAAA;AAEA;EACE;IACE,mBAAA;EAGF;AACF","sourcesContent":[":root {\n  --bg-color: black;\n  --bg-color-2: #060;\n  --fg-color: #0f0;\n}\nbody {\n  font-family: Manufab;\n  width: 100vw;\n  height: 100vh;\n  display: flex;\n  flex-direction: column;\n  margin: 0;\n  background: var(--bg-color-2);\n  color: var(--fg-color);\n  header,\n  footer,\n  #bg {\n    flex-grow: 0;\n  }\n  button#clear {\n    position: absolute;\n    top: 10px;\n    right: 10px;\n    color: var(--fg-color);\n    font-size: 18px;\n    font-variation-settings: \"wght\" 300;\n    background: none;\n    border: 2px solid var(--fg-color);\n    height: 30px;\n    width: 30px;\n  }\n  header {\n    justify-content: center;\n    align-items: center;\n    width: 100vw;\n    height: 50px;\n    max-width: 600px;\n    margin: auto;\n    display: flex;\n    flex-direction: row;\n    #logo,\n    #clear {\n      height: 30px;\n      width: 30px;\n    }\n    h1 {\n      display: flex;\n      align-items: center;\n      line-height: 30px;\n      height: 40px;\n      font-variation-settings: \"wght\" 700;\n      margin: 0 10px;\n    }\n  }\n  main {\n    display: flex;\n    flex-grow: 1;\n    flex-direction: column-reverse;\n    > :first-child {\n      background-color: var(--fg-color);\n      color: var(--bg-color);\n      &.error {\n        background-color: #a04;\n      }\n    }\n    section {\n      padding: 10px;\n      display: flex;\n      border-top: 2px solid var(--bg-color);\n      justify-content: center;\n      position: relative;\n      &.error {\n        background-color: #f06;\n      }\n      .home .tale::after {\n        content: \"=\";\n        font-size: 15px;\n        font-variation-settings: \"wght\" 200;\n        position: absolute;\n        right: -30px;\n        top: 10px;\n      }\n      .home {\n        flex-shrink: 1;\n        flex-grow: 1;\n      }\n      .away {\n        flex-shrink: 0;\n        flex-grow: 0;\n      }\n      .home,\n      .away {\n        width: 50%;\n        display: flex;\n        position: relative;\n        max-width: 300px;\n        flex-direction: column;\n        .tale,\n        .code {\n          text-align: right;\n        }\n        .tale {\n          font-size: 27px;\n        }\n      }\n    }\n  }\n  footer {\n    padding: 20px;\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n    width: auto;\n    position: relative;\n    .bg {\n      background: #f003;\n      position: absolute;\n      top: 0px;\n      bottom: 0px;\n      right: 0px;\n      left: 0px;\n      &::before {\n        content: \"\";\n        background: var(--bg-color);\n        position: absolute;\n        top: 0px;\n        bottom: 0px;\n        right: 0px;\n        left: 0px;\n      }\n    }\n    form {\n      display: flex;\n      position: relative;\n      margin: 20px auto;\n      width: 100%;\n      max-width: 600px;\n      flex-direction: column;\n      section:first-child {\n        display: flex;\n        flex-direction: column;\n        select {\n          -moz-appearance: none;\n          -webkit-appearance: none;\n          font-family: Theia;\n          color: var(--fg-color);\n          font-size: 21px;\n          font-weight: 300;\n          background: none;\n          border: 2px solid var(--fg-color);\n          border-radius: 0;\n          transition-property: outline;\n          transition-duration: 200ms;\n          padding: 5px;\n          position: relative;\n          &::before {\n            content: \"v\";\n            font-family: Icon;\n            display: block;\n            position: absolute;\n            right: 10px;\n            top: 10px;\n          }\n          ~ select {\n            margin-top: 20px;\n          }\n          &:focus-within {\n            outline: 1px solid var(--fg-color);\n            background: #020;\n            font-weight: 400;\n          }\n        }\n      }\n      section:last-child {\n        width: 100%;\n        margin-top: 20px;\n        display: flex;\n        flex-direction: row;\n        input {\n          width: 100%;\n          flex-shrink: 1;\n          font-family: Manufab;\n          text-align: end;\n          color: var(--fg-color);\n          font-size: 40px;\n          font-variation-settings: \"wght\" 600;\n          background: none;\n          border: none;\n          border-bottom: 2px solid var(--fg-color);\n          border-radius: 0;\n          outline: none;\n          margin-right: 20px;\n        }\n        button[type=\"submit\"] {\n          flex-shrink: 0;\n          font-size: 20px;\n          font-variation-settings: \"wght\" 300;\n          background: var(--fg-color);\n          color: var(--bg-color);\n          border: none;\n          height: 54px;\n          width: 54px;\n        }\n      }\n    }\n  }\n}\n\nbutton {\n  cursor: pointer;\n  user-select: none;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-family: Icon;\n  border-radius: 0;\n  border: none;\n  outline: none;\n  &:hover,\n  &:focus {\n    transform: scale(1.01);\n  }\n  &:active {\n    transition-duration: 10ms;\n    transform: scale(0.99);\n  }\n}\n\n/* Fucking dumbass Chrome (29+) that doesn't render variable fonts right */\n\n@media screen and (-webkit-min-device-pixel-ratio: 0) and (min-resolution: 0.001dpcm) {\n  body header h1 {\n    padding-bottom: 5px;\n  }\n}\n"],"sourceRoot":""}]);
// Exports
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("data:font/woff2;base64,");
...
/* harmony export */ });
/* harmony import */ var _data_CURRENCY_DICT_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../data/CURRENCY_DICT.json */ "./src/js/data/CURRENCY_DICT.json");
...
class Currency {
  ...
  static nameFromCode(currencyCode) {
    const { name } = _data_CURRENCY_DICT_json__WEBPACK_IMPORTED_MODULE_0__.find(
...
/* harmony export */ });
/* harmony import */ var _Currency__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Currency */ "./src/js/biz/Currency.js");


/* eslint-disable prefer-destructuring */
const API_KEY = "97047404743825909f47eaf3"
...
class Market {
  static convertCurrency({ from, to, howMany = 1 }) {
    return fetch(`https://v6.exchangerate-api.com/v6/${API_KEY}/latest/${from}`)
      ...
      .then(response => _Currency__WEBPACK_IMPORTED_MODULE_0__.default.convert({ original: response, to, howMany }))
      .catch(error => error)
  }
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "whichever": () => (/* binding */ whichever),
...
/***/ "./src/js/data/CODE_NAME_SET.json":
/*!****************************************!*\
  !*** ./src/js/data/CODE_NAME_SET.json ***!
  \****************************************/
/***/ ((module) => {
...
"use strict";
module.exports = JSON.parse('[{"name":"UAE Dirham","code":"AED"},{"name":"Afghani","code":"AFN"},{"name":"Lek","code":"ALL"},{"name":"Armenian Dram","code":"AMD"},{"name":"Netherlands Antillean Guilder","code":"ANG"},{"name":"Kwanza","code":"AOA"},{"name":"Argentine Peso","code":"ARS"},{"name":"Australian Dollar","code":"AUD"},{"name":"Aruban Florin","code":"AWG"},{"name":"Azerbaijanian Manat","code":"AZN"},{"name":"Convertible Mark","code":"BAM"},{"name":"Barbados Dollar","code":"BBD"},{"name":"Taka","code":"BDT"},{"name":"Bulgarian Lev","code":"BGN"},{"name":"Bahraini Dinar","code":"BHD"},{"name":"Burundi Franc","code":"BIF"},{"name":"Bermudian Dollar","code":"BMD"},{"name":"Brunei Dollar","code":"BND"},{"name":"Boliviano","code":"BOB"},{"name":"Brazilian Real","code":"BRL"},{"name":"Bahamian Dollar","code":"BSD"},{"name":"Ngultrum","code":"BTN"},{"name":"Pula","code":"BWP"},{"name":"Belarussian Ruble","code":"BYN"},{"name":"Belize Dollar","code":"BZD"},{"name":"Canadian Dollar","code":"CAD"},{"name":"Congolese Franc","code":"CDF"},{"name":"Swiss Franc","code":"CHF"},{"name":"Chilean Peso","code":"CLP"},{"name":"Yuan Renminbi","code":"CNY"},{"name":"Colombian Peso","code":"COP"},{"name":"Costa Rican Colon","code":"CRC"},{"name":"Peso Convertible","code":"CUC"},{"name":"Cuban Peso","code":"CUP"},{"name":"Cabo Verde Escudo","code":"CVE"},{"name":"Czech Koruna","code":"CZK"},{"name":"Djibouti Franc","code":"DJF"},{"name":"Danish Krone","code":"DKK"},{"name":"Dominican Peso","code":"DOP"},{"name":"Algerian Dinar","code":"DZD"},{"name":"Egyptian Pound","code":"EGP"},{"name":"Nakfa","code":"ERN"},{"name":"Ethiopian Birr","code":"ETB"},{"name":"Euro","code":"EUR"},{"name":"Fiji Dollar","code":"FJD"},{"name":"Falkland Islands Pound","code":"FKP"},{"name":"Pound Sterling","code":"GBP"},{"name":"Lari","code":"GEL"},{"name":"Ghana Cedi","code":"GHS"},{"name":"Gibraltar Pound","code":"GIP"},{"name":"Dalasi","code":"GMD"},{"name":"Guinea Franc","code":"GNF"},{"name":"Quetzal","code":"GTQ"},{"name":"Guyana Dollar","code":"GYD"},{"name":"Hong Kong Dollar","code":"HKD"},{"name":"Lempira","code":"HNL"},{"name":"Kuna","code":"HRK"},{"name":"Gourde","code":"HTG"},{"name":"Forint","code":"HUF"},{"name":"Rupiah","code":"IDR"},{"name":"New Israeli Sheqel","code":"ILS"},{"name":"Indian Rupee","code":"INR"},{"name":"Iraqi Dinar","code":"IQD"},{"name":"Iranian Rial","code":"IRR"},{"name":"Iceland Krona","code":"ISK"},{"name":"Jamaican Dollar","code":"JMD"},{"name":"Jordanian Dinar","code":"JOD"},{"name":"Yen","code":"JPY"},{"name":"Kenyan Shilling","code":"KES"},{"name":"Som","code":"KGS"},{"name":"Riel","code":"KHR"},{"name":"Comoro Franc","code":"KMF"},{"name":"Won","code":"KRW"},{"name":"Kuwaiti Dinar","code":"KWD"},{"name":"Cayman Islands Dollar","code":"KYD"},{"name":"Tenge","code":"KZT"},{"name":"Kip","code":"LAK"},{"name":"Lebanese Pound","code":"LBP"},{"name":"Sri Lanka Rupee","code":"LKR"},{"name":"Liberian Dollar","code":"LRD"},{"name":"Loti","code":"LSL"},{"name":"Libyan Dinar","code":"LYD"},{"name":"Moroccan Dirham","code":"MAD"},{"name":"Moldovan Leu","code":"MDL"},{"name":"Malagasy Ariary","code":"MGA"},{"name":"Denar","code":"MKD"},{"name":"Kyat","code":"MMK"},{"name":"Tugrik","code":"MNT"},{"name":"Pataca","code":"MOP"},{"name":"Ouguiya","code":"MRU"},{"name":"Mauritius Rupee","code":"MUR"},{"name":"Rufiyaa","code":"MVR"},{"name":"Kwacha","code":"MWK"},{"name":"Mexican Peso","code":"MXN"},{"name":"Malaysian Ringgit","code":"MYR"},{"name":"Mozambique Metical","code":"MZN"},{"name":"Namibia Dollar","code":"NAD"},{"name":"Naira","code":"NGN"},{"name":"Cordoba Oro","code":"NIO"},{"name":"Norwegian Krone","code":"NOK"},{"name":"Nepalese Rupee","code":"NPR"},{"name":"New Zealand Dollar","code":"NZD"},{"name":"Rial Omani","code":"OMR"},{"name":"Balboa","code":"PAB"},{"name":"Nuevo Sol","code":"PEN"},{"name":"Kina","code":"PGK"},{"name":"Philippine Peso","code":"PHP"},{"name":"Pakistan Rupee","code":"PKR"},{"name":"Zloty","code":"PLN"},{"name":"Guarani","code":"PYG"},{"name":"Qatari Rial","code":"QAR"},{"name":"Romanian Leu","code":"RON"},{"name":"Serbian Dinar","code":"RSD"},{"name":"Russian Ruble","code":"RUB"},{"name":"Rwanda Franc","code":"RWF"},{"name":"Saudi Riyal","code":"SAR"},{"name":"Solomon Islands Dollar","code":"SBD"},{"name":"Seychelles Rupee","code":"SCR"},{"name":"Sudanese Pound","code":"SDG"},{"name":"Swedish Krona","code":"SEK"},{"name":"Singapore Dollar","code":"SGD"},{"name":"Saint Helena Pound","code":"SHP"},{"name":"Leone","code":"SLL"},{"name":"Somali Shilling","code":"SOS"},{"name":"Surinam Dollar","code":"SRD"},{"name":"South Sudanese Pound","code":"SSP"},{"name":"Dobra","code":"STN"},{"name":"Syrian Pound","code":"SYP"},{"name":"Lilangeni","code":"SZL"},{"name":"Baht","code":"THB"},{"name":"Somoni","code":"TJS"},{"name":"Turkmenistan New Manat","code":"TMT"},{"name":"Tunisian Dinar","code":"TND"},{"name":"Pa’anga","code":"TOP"},{"name":"Turkish Lira","code":"TRY"},{"name":"Trinidad and Tobago Dollar","code":"TTD"},{"name":"New Taiwan Dollar","code":"TWD"},{"name":"Tanzanian Shilling","code":"TZS"},{"name":"Hryvnia","code":"UAH"},{"name":"Uganda Shilling","code":"UGX"},{"name":"US Dollar","code":"USD"},{"name":"Peso Uruguayo","code":"UYU"},{"name":"Uzbekistan Sum","code":"UZS"},{"name":"Dong","code":"VND"},{"name":"Vatu","code":"VUV"},{"name":"Tala","code":"WST"},{"name":"CFA Franc BEAC","code":"XAF"},{"name":"East Caribbean Dollar","code":"XCD"},{"name":"SDR (Special Drawing Right)","code":"XDR"},{"name":"CFA Franc BCEAO","code":"XOF"},{"name":"CFP Franc","code":"XPF"},{"name":"Yemeni Rial","code":"YER"},{"name":"Rand","code":"ZAR"},{"name":"Zambian Kwacha","code":"ZMW"}]');

/***/ }),

/***/ "./src/js/data/CURRENCY_DICT.json":
/*!****************************************!*\
  !*** ./src/js/data/CURRENCY_DICT.json ***!
  \****************************************/
/***/ ((module) => {
...
"use strict";
module.exports = JSON.parse('[{"country":"AFGHANISTAN","name":"Afghani","code":"AFN","number":971},{"country":"ÅLAND ISLANDS","name":"Euro","code":"EUR","number":978},{"country":"ALBANIA","name":"Lek","code":"ALL","number":8},{"country":"ALGERIA","name":"Algerian Dinar","code":"DZD","number":12},{"country":"AMERICAN SAMOA","name":"US Dollar","code":"USD","number":840},{"country":"ANDORRA","name":"Euro","code":"EUR","number":978},{"country":"ANGOLA","name":"Kwanza","code":"AOA","number":973},{"country":"ANGUILLA","name":"East Caribbean Dollar","code":"XCD","number":951},{"country":"ANTIGUA AND BARBUDA","name":"East Caribbean Dollar","code":"XCD","number":951},{"country":"ARGENTINA","name":"Argentine Peso","code":"ARS","number":32},{"country":"ARMENIA","name":"Armenian Dram","code":"AMD","number":51},{"country":"ARUBA","name":"Aruban Florin","code":"AWG","number":533},{"country":"AUSTRALIA","name":"Australian Dollar","code":"AUD","number":36},{"country":"AUSTRIA","name":"Euro","code":"EUR","number":978},{"country":"AZERBAIJAN","name":"Azerbaijanian Manat","code":"AZN","number":944},{"country":"BAHAMAS (THE)","name":"Bahamian Dollar","code":"BSD","number":44},{"country":"BAHRAIN","name":"Bahraini Dinar","code":"BHD","number":48},{"country":"BANGLADESH","name":"Taka","code":"BDT","number":50},{"country":"BARBADOS","name":"Barbados Dollar","code":"BBD","number":52},{"country":"BELARUS","name":"Belarussian Ruble","code":"BYN","number":933},{"country":"BELGIUM","name":"Euro","code":"EUR","number":978},{"country":"BELIZE","name":"Belize Dollar","code":"BZD","number":84},{"country":"BENIN","name":"CFA Franc BCEAO","code":"XOF","number":952},{"country":"BERMUDA","name":"Bermudian Dollar","code":"BMD","number":60},{"country":"BHUTAN","name":"Ngultrum","code":"BTN","number":64},{"country":"BHUTAN","name":"Indian Rupee","code":"INR","number":356},{"country":"BOLIVIA (PLURINATIONAL STATE    OF)","name":"Boliviano","code":"BOB","number":68},{"country":"BOLIVIA (PLURINATIONAL STATE    OF)","name":"Mvdol","code":"BOV","number":984},{"country":"BONAIRE, SINT EUSTATIUS AND    SABA","name":"US Dollar","code":"USD","number":840},{"country":"BOSNIA AND HERZEGOVINA","name":"Convertible Mark","code":"BAM","number":977},{"country":"BOTSWANA","name":"Pula","code":"BWP","number":72},{"country":"BOUVET ISLAND","name":"Norwegian Krone","code":"NOK","number":578},{"country":"BRAZIL","name":"Brazilian Real","code":"BRL","number":986},{"country":"BRITISH INDIAN OCEAN    TERRITORY (THE)","name":"US Dollar","code":"USD","number":840},{"country":"BRUNEI DARUSSALAM","name":"Brunei Dollar","code":"BND","number":96},{"country":"BULGARIA","name":"Bulgarian Lev","code":"BGN","number":975},{"country":"BURKINA FASO","name":"CFA Franc BCEAO","code":"XOF","number":952},{"country":"BURUNDI","name":"Burundi Franc","code":"BIF","number":108},{"country":"CABO VERDE","name":"Cabo Verde Escudo","code":"CVE","number":132},{"country":"CAMBODIA","name":"Riel","code":"KHR","number":116},{"country":"CAMEROON","name":"CFA Franc BEAC","code":"XAF","number":950},{"country":"CANADA","name":"Canadian Dollar","code":"CAD","number":124},{"country":"CAYMAN ISLANDS (THE)","name":"Cayman Islands Dollar","code":"KYD","number":136},{"country":"CENTRAL AFRICAN REPUBLIC    (THE)","name":"CFA Franc BEAC","code":"XAF","number":950},{"country":"CHAD","name":"CFA Franc BEAC","code":"XAF","number":950},{"country":"CHILE","name":"Unidad de Fomento","code":"CLF","number":990},{"country":"CHILE","name":"Chilean Peso","code":"CLP","number":152},{"country":"CHINA","name":"Yuan Renminbi","code":"CNY","number":156},{"country":"CHRISTMAS ISLAND","name":"Australian Dollar","code":"AUD","number":36},{"country":"COCOS (KEELING) ISLANDS (THE)","name":"Australian Dollar","code":"AUD","number":36},{"country":"COLOMBIA","name":"Colombian Peso","code":"COP","number":170},{"country":"COLOMBIA","name":"Unidad de Valor Real","code":"COU","number":970},{"country":"COMOROS (THE)","name":"Comoro Franc","code":"KMF","number":174},{"country":"CONGO (THE DEMOCRATIC    REPUBLIC OF THE)","name":"Congolese Franc","code":"CDF","number":976},{"country":"CONGO (THE)","name":"CFA Franc BEAC","code":"XAF","number":950},{"country":"COOK ISLANDS (THE)","name":"New Zealand Dollar","code":"NZD","number":554},{"country":"COSTA RICA","name":"Costa Rican Colon","code":"CRC","number":188},{"country":"CÔTE D\'IVOIRE","name":"CFA Franc BCEAO","code":"XOF","number":952},{"country":"CROATIA","name":"Kuna","code":"HRK","number":191},{"country":"CUBA","name":"Peso Convertible","code":"CUC","number":931},{"country":"CUBA","name":"Cuban Peso","code":"CUP","number":192},{"country":"CURAÇAO","name":"Netherlands Antillean Guilder","code":"ANG","number":532},{"country":"CYPRUS","name":"Euro","code":"EUR","number":978},{"country":"CZECH REPUBLIC (THE)","name":"Czech Koruna","code":"CZK","number":203},{"country":"DENMARK","name":"Danish Krone","code":"DKK","number":208},{"country":"DJIBOUTI","name":"Djibouti Franc","code":"DJF","number":262},{"country":"DOMINICA","name":"East Caribbean Dollar","code":"XCD","number":951},{"country":"DOMINICAN REPUBLIC (THE)","name":"Dominican Peso","code":"DOP","number":214},{"country":"ECUADOR","name":"US Dollar","code":"USD","number":840},{"country":"EGYPT","name":"Egyptian Pound","code":"EGP","number":818},{"country":"EL SALVADOR","name":"El Salvador Colon","code":"SVC","number":222},{"country":"EL SALVADOR","name":"US Dollar","code":"USD","number":840},{"country":"EQUATORIAL GUINEA","name":"CFA Franc BEAC","code":"XAF","number":950},{"country":"ERITREA","name":"Nakfa","code":"ERN","number":232},{"country":"ESTONIA","name":"Euro","code":"EUR","number":978},{"country":"ETHIOPIA","name":"Ethiopian Birr","code":"ETB","number":230},{"country":"EUROPEAN UNION","name":"Euro","code":"EUR","number":978},{"country":"FALKLAND ISLANDS (THE)    [MALVINAS]","name":"Falkland Islands Pound","code":"FKP","number":238},{"country":"FAROE ISLANDS (THE)","name":"Danish Krone","code":"DKK","number":208},{"country":"FIJI","name":"Fiji Dollar","code":"FJD","number":242},{"country":"FINLAND","name":"Euro","code":"EUR","number":978},{"country":"FRANCE","name":"Euro","code":"EUR","number":978},{"country":"FRENCH GUIANA","name":"Euro","code":"EUR","number":978},{"country":"FRENCH POLYNESIA","name":"CFP Franc","code":"XPF","number":953},{"country":"FRENCH SOUTHERN TERRITORIES    (THE)","name":"Euro","code":"EUR","number":978},{"country":"GABON","name":"CFA Franc BEAC","code":"XAF","number":950},{"country":"GAMBIA (THE)","name":"Dalasi","code":"GMD","number":270},{"country":"GEORGIA","name":"Lari","code":"GEL","number":981},{"country":"GERMANY","name":"Euro","code":"EUR","number":978},{"country":"GHANA","name":"Ghana Cedi","code":"GHS","number":936},{"country":"GIBRALTAR","name":"Gibraltar Pound","code":"GIP","number":292},{"country":"GREECE","name":"Euro","code":"EUR","number":978},{"country":"GREENLAND","name":"Danish Krone","code":"DKK","number":208},{"country":"GRENADA","name":"East Caribbean Dollar","code":"XCD","number":951},{"country":"GUADELOUPE","name":"Euro","code":"EUR","number":978},{"country":"GUAM","name":"US Dollar","code":"USD","number":840},{"country":"GUATEMALA","name":"Quetzal","code":"GTQ","number":320},{"country":"GUERNSEY","name":"Pound Sterling","code":"GBP","number":826},{"country":"GUINEA","name":"Guinea Franc","code":"GNF","number":324},{"country":"GUINEA-BISSAU","name":"CFA Franc BCEAO","code":"XOF","number":952},{"country":"GUYANA","name":"Guyana Dollar","code":"GYD","number":328},{"country":"HAITI","name":"Gourde","code":"HTG","number":332},{"country":"HAITI","name":"US Dollar","code":"USD","number":840},{"country":"HEARD ISLAND AND McDONALD    ISLANDS","name":"Australian Dollar","code":"AUD","number":36},{"country":"HOLY SEE (THE)","name":"Euro","code":"EUR","number":978},{"country":"HONDURAS","name":"Lempira","code":"HNL","number":340},{"country":"HONG KONG","name":"Hong Kong Dollar","code":"HKD","number":344},{"country":"HUNGARY","name":"Forint","code":"HUF","number":348},{"country":"ICELAND","name":"Iceland Krona","code":"ISK","number":352},{"country":"INDIA","name":"Indian Rupee","code":"INR","number":356},{"country":"INDONESIA","name":"Rupiah","code":"IDR","number":360},{"country":"INTERNATIONAL MONETARY FUND    (IMF)","name":"SDR (Special Drawing Right)","code":"XDR","number":960},{"country":"IRAN (ISLAMIC REPUBLIC OF)","name":"Iranian Rial","code":"IRR","number":364},{"country":"IRAQ","name":"Iraqi Dinar","code":"IQD","number":368},{"country":"IRELAND","name":"Euro","code":"EUR","number":978},{"country":"ISLE OF MAN","name":"Pound Sterling","code":"GBP","number":826},{"country":"ISRAEL","name":"New Israeli Sheqel","code":"ILS","number":376},{"country":"ITALY","name":"Euro","code":"EUR","number":978},{"country":"JAMAICA","name":"Jamaican Dollar","code":"JMD","number":388},{"country":"JAPAN","name":"Yen","code":"JPY","number":392},{"country":"JERSEY","name":"Pound Sterling","code":"GBP","number":826},{"country":"JORDAN","name":"Jordanian Dinar","code":"JOD","number":400},{"country":"KAZAKHSTAN","name":"Tenge","code":"KZT","number":398},{"country":"KENYA","name":"Kenyan Shilling","code":"KES","number":404},{"country":"KIRIBATI","name":"Australian Dollar","code":"AUD","number":36},{"country":"KOREA (THE DEMOCRATIC    PEOPLE’S REPUBLIC OF)","name":"North Korean Won","code":"KPW","number":408},{"country":"KOREA (THE REPUBLIC OF)","name":"Won","code":"KRW","number":410},{"country":"KUWAIT","name":"Kuwaiti Dinar","code":"KWD","number":414},{"country":"KYRGYZSTAN","name":"Som","code":"KGS","number":417},{"country":"LAO PEOPLE’S DEMOCRATIC    REPUBLIC (THE)","name":"Kip","code":"LAK","number":418},{"country":"LATVIA","name":"Euro","code":"EUR","number":978},{"country":"LEBANON","name":"Lebanese Pound","code":"LBP","number":422},{"country":"LESOTHO","name":"Loti","code":"LSL","number":426},{"country":"LESOTHO","name":"Rand","code":"ZAR","number":710},{"country":"LIBERIA","name":"Liberian Dollar","code":"LRD","number":430},{"country":"LIBYA","name":"Libyan Dinar","code":"LYD","number":434},{"country":"LIECHTENSTEIN","name":"Swiss Franc","code":"CHF","number":756},{"country":"LITHUANIA","name":"Euro","code":"EUR","number":978},{"country":"LUXEMBOURG","name":"Euro","code":"EUR","number":978},{"country":"MACAO","name":"Pataca","code":"MOP","number":446},{"country":"REPUBLIC OF NORTH MACEDONIA","name":"Denar","code":"MKD","number":807},{"country":"MADAGASCAR","name":"Malagasy Ariary","code":"MGA","number":969},{"country":"MALAWI","name":"Kwacha","code":"MWK","number":454},{"country":"MALAYSIA","name":"Malaysian Ringgit","code":"MYR","number":458},{"country":"MALDIVES","name":"Rufiyaa","code":"MVR","number":462},{"country":"MALI","name":"CFA Franc BCEAO","code":"XOF","number":952},{"country":"MALTA","name":"Euro","code":"EUR","number":978},{"country":"MARSHALL ISLANDS (THE)","name":"US Dollar","code":"USD","number":840},{"country":"MARTINIQUE","name":"Euro","code":"EUR","number":978},{"country":"MAURITANIA","name":"Ouguiya","code":"MRU","number":929},{"country":"MAURITIUS","name":"Mauritius Rupee","code":"MUR","number":480},{"country":"MAYOTTE","name":"Euro","code":"EUR","number":978},{"country":"MEMBER COUNTRIES OF THE    AFRICAN DEVELOPMENT BANK GROUP","name":"ADB Unit of Account","code":"XUA","number":965},{"country":"MEXICO","name":"Mexican Peso","code":"MXN","number":484},{"country":"MEXICO","name":"Mexican Unidad de Inversion (UDI)","code":"MXV","number":979},{"country":"MICRONESIA (FEDERATED STATES    OF)","name":"US Dollar","code":"USD","number":840},{"country":"MOLDOVA (THE REPUBLIC OF)","name":"Moldovan Leu","code":"MDL","number":498},{"country":"MONACO","name":"Euro","code":"EUR","number":978},{"country":"MONGOLIA","name":"Tugrik","code":"MNT","number":496},{"country":"MONTENEGRO","name":"Euro","code":"EUR","number":978},{"country":"MONTSERRAT","name":"East Caribbean Dollar","code":"XCD","number":951},{"country":"MOROCCO","name":"Moroccan Dirham","code":"MAD","number":504},{"country":"MOZAMBIQUE","name":"Mozambique Metical","code":"MZN","number":943},{"country":"MYANMAR","name":"Kyat","code":"MMK","number":104},{"country":"NAMIBIA","name":"Namibia Dollar","code":"NAD","number":516},{"country":"NAMIBIA","name":"Rand","code":"ZAR","number":710},{"country":"NAURU","name":"Australian Dollar","code":"AUD","number":36},{"country":"NEPAL","name":"Nepalese Rupee","code":"NPR","number":524},{"country":"NETHERLANDS (THE)","name":"Euro","code":"EUR","number":978},{"country":"NEW CALEDONIA","name":"CFP Franc","code":"XPF","number":953},{"country":"NEW ZEALAND","name":"New Zealand Dollar","code":"NZD","number":554},{"country":"NICARAGUA","name":"Cordoba Oro","code":"NIO","number":558},{"country":"NIGER (THE)","name":"CFA Franc BCEAO","code":"XOF","number":952},{"country":"NIGERIA","name":"Naira","code":"NGN","number":566},{"country":"NIUE","name":"New Zealand Dollar","code":"NZD","number":554},{"country":"NORFOLK ISLAND","name":"Australian Dollar","code":"AUD","number":36},{"country":"NORTHERN MARIANA ISLANDS    (THE)","name":"US Dollar","code":"USD","number":840},{"country":"NORWAY","name":"Norwegian Krone","code":"NOK","number":578},{"country":"OMAN","name":"Rial Omani","code":"OMR","number":512},{"country":"PAKISTAN","name":"Pakistan Rupee","code":"PKR","number":586},{"country":"PALAU","name":"US Dollar","code":"USD","number":840},{"country":"PANAMA","name":"Balboa","code":"PAB","number":590},{"country":"PANAMA","name":"US Dollar","code":"USD","number":840},{"country":"PAPUA NEW GUINEA","name":"Kina","code":"PGK","number":598},{"country":"PARAGUAY","name":"Guarani","code":"PYG","number":600},{"country":"PERU","name":"Nuevo Sol","code":"PEN","number":604},{"country":"PHILIPPINES (THE)","name":"Philippine Peso","code":"PHP","number":608},{"country":"PITCAIRN","name":"New Zealand Dollar","code":"NZD","number":554},{"country":"POLAND","name":"Zloty","code":"PLN","number":985},{"country":"PORTUGAL","name":"Euro","code":"EUR","number":978},{"country":"PUERTO RICO","name":"US Dollar","code":"USD","number":840},{"country":"QATAR","name":"Qatari Rial","code":"QAR","number":634},{"country":"RÉUNION","name":"Euro","code":"EUR","number":978},{"country":"ROMANIA","name":"Romanian Leu","code":"RON","number":946},{"country":"RUSSIAN FEDERATION (THE)","name":"Russian Ruble","code":"RUB","number":643},{"country":"RWANDA","name":"Rwanda Franc","code":"RWF","number":646},{"country":"SAINT BARTHÉLEMY","name":"Euro","code":"EUR","number":978},{"country":"SAINT HELENA, ASCENSION AND    TRISTAN DA CUNHA","name":"Saint Helena Pound","code":"SHP","number":654},{"country":"SAINT KITTS AND NEVIS","name":"East Caribbean Dollar","code":"XCD","number":951},{"country":"SAINT LUCIA","name":"East Caribbean Dollar","code":"XCD","number":951},{"country":"SAINT MARTIN (FRENCH PART)","name":"Euro","code":"EUR","number":978},{"country":"SAINT PIERRE AND MIQUELON","name":"Euro","code":"EUR","number":978},{"country":"SAINT VINCENT AND THE    GRENADINES","name":"East Caribbean Dollar","code":"XCD","number":951},{"country":"SAMOA","name":"Tala","code":"WST","number":882},{"country":"SAN MARINO","name":"Euro","code":"EUR","number":978},{"country":"SAO TOME AND PRINCIPE","name":"Dobra","code":"STN","number":930},{"country":"SAUDI ARABIA","name":"Saudi Riyal","code":"SAR","number":682},{"country":"SENEGAL","name":"CFA Franc BCEAO","code":"XOF","number":952},{"country":"SERBIA","name":"Serbian Dinar","code":"RSD","number":941},{"country":"SEYCHELLES","name":"Seychelles Rupee","code":"SCR","number":690},{"country":"SIERRA LEONE","name":"Leone","code":"SLL","number":694},{"country":"SINGAPORE","name":"Singapore Dollar","code":"SGD","number":702},{"country":"SINT MAARTEN (DUTCH PART)","name":"Netherlands Antillean Guilder","code":"ANG","number":532},{"country":"SISTEMA UNITARIO DE    COMPENSACION REGIONAL DE PAGOS \\"SUCRE\\"","name":"Sucre","code":"XSU","number":994},{"country":"SLOVAKIA","name":"Euro","code":"EUR","number":978},{"country":"SLOVENIA","name":"Euro","code":"EUR","number":978},{"country":"SOLOMON ISLANDS","name":"Solomon Islands Dollar","code":"SBD","number":90},{"country":"SOMALIA","name":"Somali Shilling","code":"SOS","number":706},{"country":"SOUTH AFRICA","name":"Rand","code":"ZAR","number":710},{"country":"SOUTH SUDAN","name":"South Sudanese Pound","code":"SSP","number":728},{"country":"SPAIN","name":"Euro","code":"EUR","number":978},{"country":"SRI LANKA","name":"Sri Lanka Rupee","code":"LKR","number":144},{"country":"SUDAN (THE)","name":"Sudanese Pound","code":"SDG","number":938},{"country":"SURINAME","name":"Surinam Dollar","code":"SRD","number":968},{"country":"SVALBARD AND JAN MAYEN","name":"Norwegian Krone","code":"NOK","number":578},{"country":"SWAZILAND","name":"Lilangeni","code":"SZL","number":748},{"country":"SWEDEN","name":"Swedish Krona","code":"SEK","number":752},{"country":"SWITZERLAND","name":"WIR Euro","code":"CHE","number":947},{"country":"SWITZERLAND","name":"Swiss Franc","code":"CHF","number":756},{"country":"SWITZERLAND","name":"WIR Franc","code":"CHW","number":948},{"country":"SYRIAN ARAB REPUBLIC","name":"Syrian Pound","code":"SYP","number":760},{"country":"TAIWAN (PROVINCE OF CHINA)","name":"New Taiwan Dollar","code":"TWD","number":901},{"country":"TAJIKISTAN","name":"Somoni","code":"TJS","number":972},{"country":"TANZANIA, UNITED REPUBLIC OF","name":"Tanzanian Shilling","code":"TZS","number":834},{"country":"THAILAND","name":"Baht","code":"THB","number":764},{"country":"TIMOR-LESTE","name":"US Dollar","code":"USD","number":840},{"country":"TOGO","name":"CFA Franc BCEAO","code":"XOF","number":952},{"country":"TOKELAU","name":"New Zealand Dollar","code":"NZD","number":554},{"country":"TONGA","name":"Pa’anga","code":"TOP","number":776},{"country":"TRINIDAD AND TOBAGO","name":"Trinidad and Tobago Dollar","code":"TTD","number":780},{"country":"TUNISIA","name":"Tunisian Dinar","code":"TND","number":788},{"country":"TURKEY","name":"Turkish Lira","code":"TRY","number":949},{"country":"TURKMENISTAN","name":"Turkmenistan New Manat","code":"TMT","number":934},{"country":"TURKS AND CAICOS ISLANDS    (THE)","name":"US Dollar","code":"USD","number":840},{"country":"TUVALU","name":"Australian Dollar","code":"AUD","number":36},{"country":"UGANDA","name":"Uganda Shilling","code":"UGX","number":800},{"country":"UKRAINE","name":"Hryvnia","code":"UAH","number":980},{"country":"UNITED ARAB EMIRATES (THE)","name":"UAE Dirham","code":"AED","number":784},{"country":"UNITED KINGDOM OF GREAT    BRITAIN AND NORTHERN IRELAND (THE)","name":"Pound Sterling","code":"GBP","number":826},{"country":"UNITED STATES MINOR OUTLYING    ISLANDS (THE)","name":"US Dollar","code":"USD","number":840},{"country":"UNITED STATES OF AMERICA    (THE)","name":"US Dollar","code":"USD","number":840},{"country":"UNITED STATES OF AMERICA    (THE)","name":"US Dollar (Next day)","code":"USN","number":997},{"country":"URUGUAY","name":"Uruguay Peso en Unidades Indexadas (URUIURUI)","code":"UYI","number":940},{"country":"URUGUAY","name":"Peso Uruguayo","code":"UYU","number":858},{"country":"UZBEKISTAN","name":"Uzbekistan Sum","code":"UZS","number":860},{"country":"VANUATU","name":"Vatu","code":"VUV","number":548},{"country":"VENEZUELA (BOLIVARIAN    REPUBLIC OF)","name":"Bolivar","code":"VEF","number":937},{"country":"VIET NAM","name":"Dong","code":"VND","number":704},{"country":"VIRGIN ISLANDS (BRITISH)","name":"US Dollar","code":"USD","number":840},{"country":"VIRGIN ISLANDS (U.S.)","name":"US Dollar","code":"USD","number":840},{"country":"WALLIS AND FUTUNA","name":"CFP Franc","code":"XPF","number":953},{"country":"WESTERN SAHARA","name":"Moroccan Dirham","code":"MAD","number":504},{"country":"YEMEN","name":"Yemeni Rial","code":"YER","number":886},{"country":"ZAMBIA","name":"Zambian Kwacha","code":"ZMW","number":967},{"country":"ZIMBABWE","name":"Zimbabwe Dollar","code":"ZWL","number":932}]');

/***/ }),

/***/ "./src/js/ui/printEntries.js":
/*!***********************************!*\
  !*** ./src/js/ui/printEntries.js ***!
  \***********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ $printEntries)
/* harmony export */ });
...
function $printEntries() {
  const $makeEntry = entry => {
    ...
    console.log(entry.home, entry.away)
    const $entry = jquery__WEBPACK_IMPORTED_MODULE_0___default()(`<section/>`)
  ...
  const $makeSide = (homeOrAway, which) => {
    ...
    const $side = jquery__WEBPACK_IMPORTED_MODULE_0___default()(`<div/>`).addClass(which)
    const $tale = jquery__WEBPACK_IMPORTED_MODULE_0___default()(`<div/>`).addClass(`tale`).text(quantity)
    const $code = jquery__WEBPACK_IMPORTED_MODULE_0___default()(`<div/>`).addClass(`code`).text(code)
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(`main`).append($entries)
}


/***/ }),

/***/ "./src/js/ui/printSelectOptions.js":
/*!*****************************************!*\
  !*** ./src/js/ui/printSelectOptions.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ $printSelectOptions)
/* harmony export */ });
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _data_CODE_NAME_SET_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../data/CODE_NAME_SET.json */ "./src/js/data/CODE_NAME_SET.json");
/* eslint-disable no-restricted-syntax */



const $makeOption = ({ code, name }) =>
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(`<option/>`).attr(`value`, code).text(`${name} (${code})`)

const $makeOptions = () =>
  _data_CODE_NAME_SET_json__WEBPACK_IMPORTED_MODULE_1__.map(codeNameObj => $makeOption(codeNameObj))

function $printSelectOptions() {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(`select#from`).append($makeOptions())
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(`select#to`).append($makeOptions())
}


/***/ }),

/***/ "./src/js/ui/randomizeInputs.js":
/*!**************************************!*\
  !*** ./src/js/ui/randomizeInputs.js ***!
  \**************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ $randomizeInputs)
/* harmony export */ });
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _biz_entropy__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../biz/entropy */ "./src/js/biz/entropy.js");
/* harmony import */ var _data_CODE_NAME_SET_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../data/CODE_NAME_SET.json */ "./src/js/data/CODE_NAME_SET.json");




function $randomizeInputs() {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(`select#from`).val((0,_biz_entropy__WEBPACK_IMPORTED_MODULE_1__.whichever)(_data_CODE_NAME_SET_json__WEBPACK_IMPORTED_MODULE_2__).code)
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(`select#to`).val((0,_biz_entropy__WEBPACK_IMPORTED_MODULE_1__.whichever)(_data_CODE_NAME_SET_json__WEBPACK_IMPORTED_MODULE_2__).code)
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(`input#how-many`).val((0,_biz_entropy__WEBPACK_IMPORTED_MODULE_1__.d)(100))
}
...
/* harmony import */ var _ui_printEntries__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./ui/printEntries */ "./src/js/ui/printEntries.js");
/* harmony import */ var _ui_randomizeInputs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./ui/randomizeInputs */ "./src/js/ui/randomizeInputs.js");
/* harmony import */ var _ui_printSelectOptions__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./ui/printSelectOptions */ "./src/js/ui/printSelectOptions.js");
/* harmony import */ var _biz_Log__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./biz/Log */ "./src/js/biz/Log.js");
/* harmony import */ var _biz_Market__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./biz/Market */ "./src/js/biz/Market.js");
// STYLE
...
jquery__WEBPACK_IMPORTED_MODULE_2___default()(() => {
  const log = new _biz_Log__WEBPACK_IMPORTED_MODULE_6__.default({ key: `conversion`, onRender: _ui_printEntries__WEBPACK_IMPORTED_MODULE_3__.default })
  ;(0,_ui_printSelectOptions__WEBPACK_IMPORTED_MODULE_5__.default)()
  ;(0,_ui_randomizeInputs__WEBPACK_IMPORTED_MODULE_4__.default)()
  jquery__WEBPACK_IMPORTED_MODULE_2___default()(`form`).on(`submit`, event => {
    event.preventDefault()
    console.log(`fired submit`)
    const from = jquery__WEBPACK_IMPORTED_MODULE_2___default()(`select#from`).val()
    const to = jquery__WEBPACK_IMPORTED_MODULE_2___default()(`select#to`).val()
    const howMany = parseInt(jquery__WEBPACK_IMPORTED_MODULE_2___default()(`input#how-many`).val(), 10) || undefined
    try {
      _biz_Market__WEBPACK_IMPORTED_MODULE_7__.default.convertCurrency({ from, to, howMany }).then(conversion => {
        log.add(conversion)
      })
    } catch (error) {
      log.add({
    ...
    jquery__WEBPACK_IMPORTED_MODULE_2___default()(`input#how-many`).val(``)
  })
  jquery__WEBPACK_IMPORTED_MODULE_2___default()(`button#clear`).on(`click`, () => {
    log.clear()
  })
})
