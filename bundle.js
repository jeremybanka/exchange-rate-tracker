...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ":root {\n  --bg-color: black;\n  --bg-color-2: #060;\n  --fg-color: #0f0;\n}\n\nbody {\n  font-family: Manufab;\n  width: 100vw;\n  height: 100vh;\n  display: flex;\n  flex-direction: column;\n  margin: 0;\n  background: var(--bg-color-2);\n  color: var(--fg-color);\n}\nbody header,\nbody footer,\nbody #bg {\n  flex-grow: 0;\n}\nbody header {\n  justify-content: center;\n  align-items: center;\n  width: 100vw;\n  height: 50px;\n  max-width: 600px;\n  display: flex;\n  flex-direction: row;\n}\nbody header #logo,\nbody header #clear {\n  height: 30px;\n  width: 30px;\n}\nbody header h1 {\n  font-variation-settings: \"wght\" 700;\n  margin: 0 10px 10px;\n  line-height: 0.8em;\n}\nbody header #clear {\n  position: absolute;\n  right: 10px;\n  color: var(--fg-color);\n  font-size: 18px;\n  font-variation-settings: \"wght\" 300;\n  background: none;\n  border: 2px solid var(--fg-color);\n}\nbody main {\n  display: flex;\n  flex-grow: 1;\n  flex-direction: column-reverse;\n}\nbody main > :first-child {\n  background-color: var(--fg-color);\n  color: var(--bg-color);\n}\nbody main section {\n  padding: 10px;\n  display: flex;\n  border-top: 2px solid var(--bg-color);\n}\nbody main section .home {\n  width: 20%;\n}\nbody main section .home,\nbody main section .away {\n  display: flex;\n  flex-direction: column;\n  flex-grow: 1;\n}\nbody main section .home .tale,\nbody main section .home .code,\nbody main section .away .tale,\nbody main section .away .code {\n  text-align: right;\n}\nbody main section .home .tale,\nbody main section .away .tale {\n  font-size: 30px;\n}\nbody footer {\n  padding: 20px;\n  display: inline-flex;\n  flex-direction: column;\n  align-items: center;\n  width: auto;\n  background: var(--bg-color);\n}\nbody footer form {\n  display: flex;\n  position: relative;\n  margin: 20px auto;\n  max-width: 600px;\n  flex-direction: column;\n}\nbody footer form,\nbody footer form * {\n  display: inline-flex;\n}\nbody footer form section:first-child {\n  flex-direction: column;\n}\nbody footer form section:first-child input {\n  font-family: Theia;\n  color: var(--fg-color);\n  font-size: 30px;\n  font-weight: 300;\n  background: none;\n  border: 2px solid var(--fg-color);\n  transition-property: background-color outline;\n  transition-duration: 200ms;\n}\nbody footer form section:first-child input ~ input {\n  margin-top: 20px;\n}\nbody footer form section:first-child input:focus-within {\n  outline: 1px solid var(--fg-color);\n  background: #020;\n  font-weight: 400;\n}\nbody footer form section:last-child {\n  margin-top: 20px;\n  display: flex;\n  flex-direction: row;\n}\nbody footer form section:last-child input {\n  font-family: Theia;\n  text-align: end;\n  color: var(--fg-color);\n  font-size: 40px;\n  font-variation-settings: \"wght\" 600;\n  background: none;\n  border: none;\n  border-bottom: 2px solid var(--fg-color);\n  margin-right: 20px;\n}\nbody footer form section:last-child button[type=submit] {\n  font-size: 20px;\n  font-variation-settings: \"wght\" 300;\n  background: var(--fg-color);\n  color: var(--bg-color);\n  border: none;\n  height: 54px;\n  width: 54px;\n}\n\nbutton {\n  cursor: pointer;\n  user-select: none;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-family: Icon;\n  border-radius: 0;\n  border: none;\n  outline: none;\n}\nbutton:hover, button:focus {\n  transform: scale(1.01);\n}\nbutton:active {\n  transition-duration: 10ms;\n  transform: scale(0.99);\n}", "",{"version":3,"sources":["webpack://./src/styles/core.scss"],"names":[],"mappings":"AAAA;EACE,iBAAA;EACA,kBAAA;EACA,gBAAA;AACF;;AAEA;EACE,oBAAA;EACA,YAAA;EACA,aAAA;EACA,aAAA;EACA,sBAAA;EACA,SAAA;EACA,6BAAA;EACA,sBAAA;AACF;AAAE;;;EAGE,YAAA;AAEJ;AAAE;EACE,uBAAA;EACA,mBAAA;EACA,YAAA;EACA,YAAA;EACA,gBAAA;EACA,aAAA;EACA,mBAAA;AAEJ;AADI;;EAEE,YAAA;EACA,WAAA;AAGN;AADI;EACE,mCAAA;EACA,mBAAA;EACA,kBAAA;AAGN;AADI;EACE,kBAAA;EACA,WAAA;EACA,sBAAA;EACA,eAAA;EACA,mCAAA;EACA,gBAAA;EACA,iCAAA;AAGN;AAAE;EACE,aAAA;EACA,YAAA;EACA,8BAAA;AAEJ;AADI;EACE,iCAAA;EACA,sBAAA;AAGN;AADI;EACE,aAAA;EACA,aAAA;EACA,qCAAA;AAGN;AAFM;EACE,UAAA;AAIR;AAFM;;EAEE,aAAA;EACA,sBAAA;EACA,YAAA;AAIR;AAHQ;;;;EAEE,iBAAA;AAOV;AALQ;;EACE,eAAA;AAQV;AAHE;EACE,aAAA;EACA,oBAAA;EACA,sBAAA;EACA,mBAAA;EACA,WAAA;EACA,2BAAA;AAKJ;AAJI;EACE,aAAA;EACA,kBAAA;EACA,iBAAA;EACA,gBAAA;EACA,sBAAA;AAMN;AALM;;EAEE,oBAAA;AAOR;AALM;EACE,sBAAA;AAOR;AANQ;EACE,kBAAA;EACA,sBAAA;EACA,eAAA;EACA,gBAAA;EACA,gBAAA;EACA,iCAAA;EACA,6CAAA;EACA,0BAAA;AAQV;AAPU;EACE,gBAAA;AASZ;AAPU;EACE,kCAAA;EACA,gBAAA;EACA,gBAAA;AASZ;AALM;EACE,gBAAA;EACA,aAAA;EACA,mBAAA;AAOR;AANQ;EACE,kBAAA;EACA,eAAA;EACA,sBAAA;EACA,eAAA;EACA,mCAAA;EACA,gBAAA;EACA,YAAA;EACA,wCAAA;EACA,kBAAA;AAQV;AANQ;EACE,eAAA;EACA,mCAAA;EACA,2BAAA;EACA,sBAAA;EACA,YAAA;EACA,YAAA;EACA,WAAA;AAQV;;AADA;EACE,eAAA;EACA,iBAAA;EACA,aAAA;EACA,mBAAA;EACA,uBAAA;EACA,iBAAA;EACA,gBAAA;EACA,YAAA;EACA,aAAA;AAIF;AAHE;EAEE,sBAAA;AAIJ;AAFE;EACE,yBAAA;EACA,sBAAA;AAIJ","sourcesContent":[":root {\n  --bg-color: black;\n  --bg-color-2: #060;\n  --fg-color: #0f0;\n}\n\nbody {\n  font-family: Manufab;\n  width: 100vw;\n  height: 100vh;\n  display: flex;\n  flex-direction: column;\n  margin: 0;\n  background: var(--bg-color-2);\n  color: var(--fg-color);\n  header,\n  footer,\n  #bg {\n    flex-grow: 0;\n  }\n  header {\n    justify-content: center;\n    align-items: center;\n    width: 100vw;\n    height: 50px;\n    max-width: 600px;\n    display: flex;\n    flex-direction: row;\n    #logo,\n    #clear {\n      height: 30px;\n      width: 30px;\n    }\n    h1 {\n      font-variation-settings: \"wght\" 700;\n      margin: 0 10px 10px;\n      line-height: 0.8em;\n    }\n    #clear {\n      position: absolute;\n      right: 10px;\n      color: var(--fg-color);\n      font-size: 18px;\n      font-variation-settings: \"wght\" 300;\n      background: none;\n      border: 2px solid var(--fg-color);\n    }\n  }\n  main {\n    display: flex;\n    flex-grow: 1;\n    flex-direction: column-reverse;\n    > :first-child {\n      background-color: var(--fg-color);\n      color: var(--bg-color);\n    }\n    section {\n      padding: 10px;\n      display: flex;\n      border-top: 2px solid var(--bg-color);\n      .home {\n        width: 20%;\n      }\n      .home,\n      .away {\n        display: flex;\n        flex-direction: column;\n        flex-grow: 1;\n        .tale,\n        .code {\n          text-align: right;\n        }\n        .tale {\n          font-size: 30px;\n        }\n      }\n    }\n  }\n  footer {\n    padding: 20px;\n    display: inline-flex;\n    flex-direction: column;\n    align-items: center;\n    width: auto;\n    background: var(--bg-color);\n    form {\n      display: flex;\n      position: relative;\n      margin: 20px auto;\n      max-width: 600px;\n      flex-direction: column;\n      &,\n      * {\n        display: inline-flex;\n      }\n      section:first-child {\n        flex-direction: column;\n        input {\n          font-family: Theia;\n          color: var(--fg-color);\n          font-size: 30px;\n          font-weight: 300;\n          background: none;\n          border: 2px solid var(--fg-color);\n          transition-property: background-color outline;\n          transition-duration: 200ms;\n          ~ input {\n            margin-top: 20px;\n          }\n          &:focus-within {\n            outline: 1px solid var(--fg-color);\n            background: #020;\n            font-weight: 400;\n          }\n        }\n      }\n      section:last-child {\n        margin-top: 20px;\n        display: flex;\n        flex-direction: row;\n        input {\n          font-family: Theia;\n          text-align: end;\n          color: var(--fg-color);\n          font-size: 40px;\n          font-variation-settings: \"wght\" 600;\n          background: none;\n          border: none;\n          border-bottom: 2px solid var(--fg-color);\n          margin-right: 20px;\n        }\n        button[type=\"submit\"] {\n          font-size: 20px;\n          font-variation-settings: \"wght\" 300;\n          background: var(--fg-color);\n          color: var(--bg-color);\n          border: none;\n          height: 54px;\n          width: 54px;\n        }\n      }\n    }\n  }\n}\n\nbutton {\n  cursor: pointer;\n  user-select: none;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-family: Icon;\n  border-radius: 0;\n  border: none;\n  outline: none;\n  &:hover,\n  &:focus {\n    transform: scale(1.01);\n  }\n  &:active {\n    transition-duration: 10ms;\n    transform: scale(0.99);\n  }\n}\n"],"sourceRoot":""}]);
// Exports
...
/* harmony export */ });
/* harmony import */ var _currency_dict_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./currency-dict.json */ "./src/js/currency-dict.json");
...
class Currency {
  ...
  static nameFromCode(currencyCode) {
    const { name } = _currency_dict_json__WEBPACK_IMPORTED_MODULE_0__.find(
...
/* harmony export */ });
/* harmony import */ var _Currency__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Currency */ "./src/js/Currency.js");
...
/* harmony import */ var _Log__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Log */ "./src/js/Log.js");
/* harmony import */ var _Market__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Market */ "./src/js/Market.js");
// STYLE
...
function $printEntries() {
  const $makeEntry = entry => {
    ...
    console.log(entry.home, entry.away)
    const $entry = jquery__WEBPACK_IMPORTED_MODULE_2___default()(`<section/>`)
  ...
  const $makeSide = (homeOrAway, which) => {
    ...
    const $side = jquery__WEBPACK_IMPORTED_MODULE_2___default()(`<div/>`).addClass(which)
    const $tale = jquery__WEBPACK_IMPORTED_MODULE_2___default()(`<div/>`).addClass(`tale`).text(quantity)
    const $code = jquery__WEBPACK_IMPORTED_MODULE_2___default()(`<div/>`).addClass(`code`).text(code)
    return $side.append($tale, $code)
  }
  const $entries = this.entries.map(entry => $makeEntry(entry))
  jquery__WEBPACK_IMPORTED_MODULE_2___default()(`main`).empty()
  jquery__WEBPACK_IMPORTED_MODULE_2___default()(`main`).append($entries)
}

jquery__WEBPACK_IMPORTED_MODULE_2___default()(() => {
  const log = new _Log__WEBPACK_IMPORTED_MODULE_3__.default({ key: `conversion`, onRender: $printEntries })
  ...
  jquery__WEBPACK_IMPORTED_MODULE_2___default()(`form`).on(`submit`, event => {
    ...
    _Market__WEBPACK_IMPORTED_MODULE_4__.default.convertCurrency({ from, to, howMany }).then(conversion => {
      log.add(conversion)
    })
