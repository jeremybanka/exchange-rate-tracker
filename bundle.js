...
/* harmony import */ var _data_CURRENCY_DICT_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../data/CURRENCY_DICT.json */ "./src/js/data/CURRENCY_DICT.json");




function $randomizeInputs() {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(`input#from`).val((0,_biz_entropy__WEBPACK_IMPORTED_MODULE_1__.whichever)(_data_CURRENCY_DICT_json__WEBPACK_IMPORTED_MODULE_2__).code)
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(`input#to`).val((0,_biz_entropy__WEBPACK_IMPORTED_MODULE_1__.whichever)(_data_CURRENCY_DICT_json__WEBPACK_IMPORTED_MODULE_2__).code)
...
/* harmony import */ var _biz_Log__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./biz/Log */ "./src/js/biz/Log.js");
/* harmony import */ var _biz_Market__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./biz/Market */ "./src/js/biz/Market.js");
// STYLE
...
jquery__WEBPACK_IMPORTED_MODULE_2___default()(() => {
  const log = new _biz_Log__WEBPACK_IMPORTED_MODULE_5__.default({ key: `conversion`, onRender: _ui_printEntries__WEBPACK_IMPORTED_MODULE_3__.default })
  ...
  jquery__WEBPACK_IMPORTED_MODULE_2___default()(`form`).on(`submit`, event => {
    ...
    const from = jquery__WEBPACK_IMPORTED_MODULE_2___default()(`input#from`).val()
    const to = jquery__WEBPACK_IMPORTED_MODULE_2___default()(`input#to`).val()
    const howMany = parseInt(jquery__WEBPACK_IMPORTED_MODULE_2___default()(`input#how-many`).val(), 10) || undefined
    _biz_Market__WEBPACK_IMPORTED_MODULE_6__.default.convertCurrency({ from, to, howMany }).then(conversion => {
      log.add(conversion)
    })
